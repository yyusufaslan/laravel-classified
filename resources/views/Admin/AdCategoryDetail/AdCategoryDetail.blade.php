            ...
            <table class="table table-striped table-hover">
                ...
                @foreach($details as $detail)
                    ...
                    <tr>
                        ...
                        <td>{{$detail->type}}</td>
                        <td>
                            <a href="{{ route('adCategoryDetail.edit', ['id' => $detail->id]) }}" class="edit" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Edit">E</i></a>
                            <a href="{{ route('adCategoryDetail.changeStatus', ['id' => $detail->id]) }}" class="edit" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Change Status">C</i></a>
                            <a href="{{ route('adCategoryDetail.delete', ['id' => $detail->id]) }}" class="delete" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Delete">D</i></a>
    ...
    <div id="addEmployeeModal" class="modal fade">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="{{ route('adCategoryDetail.create') }}" method="post">
